 ...
 *
 * <p>
 * 정답 코드 확인이 필요하면 강사용 SOLVED 프로젝트 또는 평가 후 공개 자료 참고.
 * </p>
 *
 * <p>
 * 참고: - 접속자 컬렉션은 여러 스레드가 동시에 접근 → Collections.synchronizedSet 사용 권장. -
...
public class ChatServer {
	...
	public static final Set<ChatHandler> clients = Collections.synchronizedSet(new HashSet<>());
	 ...
	 *
	 * <p>
	 * 학생 TODO: clients 컬렉션을 (스레드 안전하게) 순회하며 각 핸들러의 send(message) 호출.
	 * </p>
	 */
